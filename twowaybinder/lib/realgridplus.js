var RealGrids = (function () {
    ...
    var win = window;
    var doc = document;
    var REQUIRED_VERSION = "1.1.26.2623";
    var DEBUG = false;
    var TRACE = false;
    ...
    */
    var GridBase = function (id, ignoreVersion) {
        ...
        this.onIndicatorCellClicked = DEBUG ? function (grid, itemIndex) {
            _log("onIndicatorCellClicked: " + "(" + itemIndex + ")");
        } : null;
        this.onIndicatorCellDblClicked = DEBUG ? function (grid, itemIndex) {
            _log("onIndicatorCellDblClicked: " + "(" + itemIndex + ")");
        } : null;
        this.onStateBarCellClicked = DEBUG ? function (grid, itemIndex) {
            _log("onStateBarCellClicked: " + "(" + itemIndex + ")");
        } : null;
        this.onStateBarCellDblClicked = DEBUG ? function (grid, itemIndex) {
    ...
    */
    ...
    return {
        ...
        onIndicatorCellClicked: function (id, itemIndex) {
            var grid = __grids[id];
            if (grid && grid.onIndicatorCellClicked) {
                grid.onIndicatorCellClicked(grid, itemIndex);
            };
        },
        onIndicatorCellDblClicked: function (id, itemIndex) {
            var grid = __grids[id];
            if (grid && grid.onIndicatorCellDblClicked) {
                grid.onIndicatorCellDblClicked(grid, itemIndex);
            };
        },
        onStateBarCellClicked: function (id, itemIndex) {
            var grid = __grids[id];
            if (grid && grid.onStateBarCellClicked) {
                grid.onStateBarCellClicked(grid, itemIndex);
            };
        },
        onStateBarCellDblClicked: function (id, itemIndex) {
            var grid = __grids[id];
            if (grid && grid.onStateBarCellDblClicked) {
                grid.onStateBarCellDblClicked(grid, itemIndex);
            };
        },
